      ...
      >
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-xl font-nunito text-lg text-white/90 sm:text-xl">
            Glory Kids Membership launches {BRAND.launchDate}. Access 200+
            done-for-you lessons, trainings, and resources—all in one growing
            vault. New curriculum every month. Cancel anytime.
          </p>
          <div className="mt-10 flex justify-center">
            <CTAButton size="lg" />
          </div>
          <p className="mt-5 font-nunito text-sm font-semibold text-[#F5A623]">
            Launching {BRAND.launchDate} — founding members lock in{" "}
            {BRAND.price}/month for life. Only {BRAND.spots} spots.
          </p>
        </motion.div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <p className="mx-auto mt-2 max-w-2xl font-nunito text-white/95">
              ...
              membership from launch day, {BRAND.launchDate}.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      >
        ...
        >
          <h2 className="font-oswald text-3xl font-bold text-white sm:text-4xl">
            Membership launches {BRAND.launchDate}
          </h2>
          <p className="mt-4 font-nunito text-lg text-white/90">
            Join the waitlist as one of {BRAND.spots} founding members. Lock in{" "}
            {BRAND.price}/month for life. New content every month. Cancel anytime.
          </p>
          ...
          <p className="mt-5 font-nunito text-sm text-white/80">
            30-day money-back guarantee. Membership opens {BRAND.launchDate}; founding member pricing closes when{" "}
